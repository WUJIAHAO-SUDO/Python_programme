...
#设置计算你的时间点
t_index1 = argmin(abs.(time_result .- 240))
t_index2 = argmin(abs.(time_result .- 540))
t_index3 = argmin(abs.(time_result .- 840))
t_index4 = argmin(abs.(time_result .- 1140))
t_index5 = argmin(abs.(time_result .- 1440))
t_index6 = argmin(abs.(time_result .- 1740))
t_index7 = argmin(abs.(time_result .- 2040))
t_index8 = argmin(abs.(time_result .- 2340))
t_index9 = argmin(abs.(time_result .- 2640))
t_index10 = argmin(abs.(time_result .- 2940))
...
p2 = plot(x_grid_p, concentration_p_p2d1, 
    ...
    lw=2, color=:blue, alpha=0.1,xlims=(0,1))
...
#3
plot!(x_grid_p, concentration_p_p2d3, label = "t=840s", alpha=0.3,
    lw=2, color=:blue,xlims=(0,1))
...
#4
plot!(x_grid_p, concentration_p_p2d4, label = "t=1140s",alpha=0.4,
    lw=2, color=:blue,xlims=(0,1))
...
#5
plot!(x_grid_p, concentration_p_p2d5,  label = "t=1440s",alpha=0.5,
    lw=2, color=:blue,xlims=(0,1))
...
#6
plot!(x_grid_p, concentration_p_p2d6,  label = "t=1740s",alpha=0.6,
    lw=2, color=:blue,xlims=(0,1))
...
#7
plot!(x_grid_p, concentration_p_p2d7,  label = "t=2040s",alpha=0.7,
    lw=2, color=:blue,xlims=(0,1))
...
#8
plot!(x_grid_p, concentration_p_p2d8, label = "t=2340s",alpha=0.8,
    lw=2, color=:blue,xlims=(0,1))
...
#9
plot!(x_grid_p, concentration_p_p2d9,  label = "t=2640s",alpha=0.9,
    lw=2, color=:blue,xlims=(0,1))
...
#10
plot!(x_grid_p, concentration_p_p2d10,  label = "t=2940s",alpha=1,
    lw=2, color=:blue,xlims=(0,1))
...
p3 = plot(x_grid_p, stress_p_p2d1, 
    ...
    lw=2, color=:"#4db8ff",alpha=0.1,xlims=(0,1))
plot!(x_grid_p, stress_p_sP2D1, 
    label="", 
    linestyle=:dot,  shape=:star,alpha=0.1,color=:"#3c9d4d")
...
plot!(x_grid_p, stress_p_p2d2, 
    ...
    xlabel="x [m]", 
    ylabel="Stress [Pa]", 
    lw=2, alpha=0.2,color=:"#4db8ff")
plot!(x_grid_p, stress_p_sP2D2, 
    label="", 
    linestyle=:dot,  shape=:star,alpha=0.2,color=:"#3c9d4d")
...
plot!(x_grid_p, stress_p_p2d3, 
    ...
    xlabel="x [m]", 
    ylabel="Stress [Pa]", 
    lw=2, alpha=0.3,color=:"#4db8ff")
plot!(x_grid_p, stress_p_sP2D3, 
    label="", 
    linestyle=:dot,  shape=:star,alpha=0.3,color=:"#3c9d4d")
...
plot!(x_grid_n, stress_sP2D4, 
    label="", 
    linestyle=:dot,  shape=:star,alpha=0.4,color=:yellow)
...
plot!(x_grid_n, stress_sP2D5, 
    label="", 
    linestyle=:dot,  shape=:star,alpha=0.5,color=:yellow)
...
plot!(x_grid_p, stress_p_p2d6, 
    ...
    xlabel="x [m]", 
    ylabel="Stress [Pa]", 
    lw=2, alpha=0.6,color=:"#4db8ff")
plot!(x_grid_p, stress_p_sP2D6, 
    label="", 
    linestyle=:dot,  shape=:star,alpha=0.6,color=:"#3c9d4d")
...
plot!(x_grid_p, stress_p_p2d7, 
    ...
    xlabel="x [m]", 
    ylabel="Stress [Pa]", 
    lw=2, alpha=0.7,color=:"#4db8ff")
plot!(x_grid_p, stress_p_sP2D7, 
    label="", 
    linestyle=:dot,  shape=:star,alpha=0.7,color=:"#3c9d4d")
...
plot!(x_grid_p, stress_p_p2d8, 
    ...
    xlabel="x [m]", 
    ylabel="Stress [Pa]", 
    lw=2, alpha=0.8,color=:"#4db8ff")
plot!(x_grid_p, stress_p_sP2D8, 
    label="", 
    linestyle=:dot,  shape=:star,alpha=0.8,color=:"#3c9d4d")
...
plot!(x_grid_n, stress_sP2D9, 
    label="", 
    alpha=0.91,color=:darkorange)
plot!(x_grid_n, stress_sP2D9, 
    label="", 
    linestyle=:dot,  shape=:star,alpha=0.9,color=:yellow)
...
plot!(x_grid_n, stress_sP2D10, 
    label="", 
    linestyle=:dot,  shape=:star,alpha=1,color=:yellow)
