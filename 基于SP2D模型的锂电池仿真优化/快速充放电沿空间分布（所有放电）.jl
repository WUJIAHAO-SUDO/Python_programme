...
t_index2 = argmin(abs.(time_result .- 360))
t_index3 = argmin(abs.(time_result .- 660))
t_index4 = argmin(abs.(time_result .- 960))
t_index5 = argmin(abs.(time_result .- 1260))
t_index6 = argmin(abs.(time_result .- 1560))
t_index7 = argmin(abs.(time_result .- 1860))
t_index8 = argmin(abs.(time_result .- 2160))
t_index9 = argmin(abs.(time_result .- 2460))
t_index10 = argmin(abs.(time_result .- 2760))
...
#3
plot!(x_grid_p, concentration_p_p2d3, label = "t=660s", alpha=0.3,
    lw=2, color=:blue,xlims=(0,1))
...
#4
plot!(x_grid_p, concentration_p_p2d4, label = "t=960s",alpha=0.4,
    lw=2, color=:blue,xlims=(0,1))
...
#5
plot!(x_grid_p, concentration_p_p2d5,  label = "t=1260s",alpha=0.5,
    lw=2, color=:blue,xlims=(0,1))
...
#6
plot!(x_grid_p, concentration_p_p2d6,  label = "t=1560s",alpha=0.6,
    lw=2, color=:blue,xlims=(0,1))
...
#7
plot!(x_grid_p, concentration_p_p2d7,  label = "t=1860s",alpha=0.7,
    lw=2, color=:blue,xlims=(0,1))
...
#8
plot!(x_grid_p, concentration_p_p2d8, label = "t=2160s",alpha=0.8,
    lw=2, color=:blue,xlims=(0,1))
...
#9
plot!(x_grid_p, concentration_p_p2d9,  label = "t=2460s",alpha=0.9,
    lw=2, color=:blue,xlims=(0,1))
...
#10
plot!(x_grid_p, concentration_p_p2d10,  label = "t=2760s",alpha=1,
    lw=2, color=:blue,xlims=(0,1))
